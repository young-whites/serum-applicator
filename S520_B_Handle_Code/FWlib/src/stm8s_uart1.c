...
/**
  * @brief  Enables or disables the UART抯 Half Duplex communication.
...
/**
  * @brief  Configures the UART抯 IrDA interface.
...
/**
  * @brief  Enables or disables the UART抯 IrDA interface.
